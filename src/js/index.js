...
const introTexts = [...intro.querySelectorAll('.row__text.overflow-hidden > span')];
...
contents.forEach(content => {
    contentTexts.push([...content.querySelectorAll('.overflow-hidden > span')]);
});
...
new Cursor(document.querySelectorAll('.cursor'), 'a, .intro-sec > .image, .content__back');
